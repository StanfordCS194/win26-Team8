...
export function ItemDetail({ item, onBack, backLabel = 'Back to list', onDelete, onRefresh, onUnlock, isUnlockedItem, onRemoveUnlocked, onUpdateCategory }: ItemDetailProps) {
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-xs text-muted-foreground mb-3">
                                  ...
                                  {item.friendEmail ? ` (${item.friendEmail})` : ''} with a link to set a password.
